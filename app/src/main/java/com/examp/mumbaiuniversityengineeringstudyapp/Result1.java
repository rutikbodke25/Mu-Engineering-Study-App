...
public class Result1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // add your link here
        wv.loadUrl("https://drive.google.com/drive/folders/1KS04RZ7YZ4QwVMCXp8H75FoqmcaazuO8?usp=sharing");
        ...
        wv.setDownloadListener(new DownloadListener() {
            ...
            public void onDownloadStart(String url, String s1, String s2, String s3, long l) {
                ...
                dm.enqueue(req);
                Toast.makeText( Result1.this, "Downloading....", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private class Client extends WebViewClient {
        ...
        public void onReceivedError(WebView webView, int errorCode, String description, String failingUrl) {
            ...
            AlertDialog alertDialog = new AlertDialog.Builder( Result1.this).create();
