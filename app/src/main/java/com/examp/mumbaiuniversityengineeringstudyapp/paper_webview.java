...
public class paper_webview extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_paper_webview);
        ...
        wv.setDownloadListener(new DownloadListener() {
            ...
            public void onDownloadStart(String url, String s1, String s2, String s3, long l) {
                ...
                dm.enqueue(req);
                Toast.makeText(paper_webview.this, "Downloading....", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private class Client extends WebViewClient {
        ...
        public void onReceivedError(WebView webView, int errorCode, String description, String failingUrl) {
            ...
            AlertDialog alertDialog = new AlertDialog.Builder(paper_webview.this).create();
